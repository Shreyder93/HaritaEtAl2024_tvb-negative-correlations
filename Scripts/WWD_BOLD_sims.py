...
value_W_I = sys.argv[3]
value_W_I = float(value_W_I)

value_Gs = sys.argv[4]
value_Gs = int(value_Gs)

value_lambda = sys.argv[5]
value_lambda = float(value_lambda)
...
regime = {'J_N': 0.18, 'J_i': 1.03, 'W_i': value_W_I, 'lamda': value_lambda} 
...
print("pcc (with BOLD) for subj {0} @ 20 mins simlen is {1}, with W_I = {2}, lambda = {3}, and Gs = {4} \n".format(sub_id, pcc_FC_test, value_W_I, value_lambda, value_Gs)) 
print(". \n")
print(". \n")
print(". \n")
### ----------------------------------------------------------------------------------------------------------------------------------------
